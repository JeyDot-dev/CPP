...
/*   Updated: 2024/01/24 20:09:11 by jsousa-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//--------------Constructors------------//
ClapTrap::ClapTrap(std::string name): _name(name), _hp(_baseHp), _ep(_baseEp), _ad(_baseAd)
{
...
ClapTrap::ClapTrap(void): _name("Nameless"), _hp(_baseHp), _ep(_baseEp), _ad(_baseAd)
{
